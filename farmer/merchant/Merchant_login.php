...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $result = $mysqli->query("SELECT * FROM musers WHERE username='$username'");
        ...
        <div id="container">
                ...
                <div id="content">
                    <ul>
                      ...
                      <form class = "login" action="Merchant_login.php" enctype="multipart/form-data" method="POST"> 
                      <h3 class="login-title">Merchant Login</h3 class="login-title">   
                      ...
                      <a class="sign-in" href="Merchant_register.php"> New User? </a > 
                      </form>   
                        </div>
                </div>
               <div id="footer">
